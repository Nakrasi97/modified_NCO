...
def get_options(args=None):
    ...
    # Training
    parser.add_argument('--lr_model', type=float, default=5e-4, help="Set the learning rate for the actor network")
    ...
    parser.add_argument('--compare_nsga', action='store_true', help='Set this value to compare NDS with NSGA and plot graphs')
    ...
    parser.add_argument('--baseline', default='NoBaseline',
